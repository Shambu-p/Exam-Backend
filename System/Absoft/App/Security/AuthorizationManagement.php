...
class AuthorizationManagement {
    ...
    private static $file_address = __DIR__."/authorization.json";
    ...
    public static function set($record, $auth){
        ...
        $auths = json_decode(file_get_contents(AuthorizationManagement::$file_address));
        ...
        file_put_contents(AuthorizationManagement::$file_address, json_encode($auths));
    ...
    public static function update($token, $auth){
        ...
        $user = ["date" => strtotime("now")];
        $auths = json_decode(file_get_contents(self::$file_address));
        ...
        file_put_contents(self::$file_address, json_encode($auths));
