...
class Administration {
    ...
    public static function variables(){
        return (array) json_decode(file_get_contents(DirConfiguration::$_main_folder."/System/Absoft/App/Administration/administration.json"));
    }
    ...
    public static function deleteVariable($name){
        ...
        if(isset($vars[$name])){
            ...
            unset($vars[$name]);
            file_put_contents(DirConfiguration::$_main_folder."/System/Absoft/App/Administration/administration.json", json_encode($vars));
